    ...
    const projects = await Promise.all([
      ...
      prisma.project.upsert({
        ...
        create: {
          ...
          description: 'A responsive chat application supporting direct messaging, group conversations, and media sharing with real-time notifications.',
      ...
      prisma.project.upsert({
        ...
        create: {
          ...
          description: 'Previous version of my personal portfolio built with React and Framer Motion with smooth animations and responsive design.',
          image: 'https://images.unsplash.com/photo-1507238691740-187a5b1d37b8?w=500&h=300&fit=crop',
          technologies: 'React, Tailwind CSS, Framer Motion',
          category: 'Frontend',
          liveUrl: 'https://example-portfolio-v1.com',
          githubUrl: 'https://github.com/example',
          featured: false,
          order: 5,
        },
      ...
      prisma.project.upsert({
        ...
        create: {
          ...
          description: 'A headless CMS backend built with GraphQL, Apollo Server, and PostgreSQL for managing content efficiently.',
          image: 'https://images.unsplash.com/photo-1555066931-4365d14bab8c?w=500&h=300&fit=crop',
          technologies: 'GraphQL, Apollo, Node.js, PostgreSQL',
          category: 'Backend',
          liveUrl: 'https://example-graphql-api.com',
          githubUrl: 'https://github.com/example',
          featured: false,
          order: 6,
        },
